...
const trainers = [
  {
    name: "Ashok",
    role: "Certified Trainer — Strength & Hypertrophy",
    experience: "8+ years",
    location: "Chennai",
    specialisation: "Strength & Hypertrophy",
    description: "Ashok leads progressive strength programming for clients focused on muscle building and body recomposition. His methodology is built around evidence-based hypertrophy principles and systematic overload cycles.",
    color: "#D4AF37",
    initials: "A",
  },
  {
    name: "Rajavel",
    role: "Certified Trainer — Fat Loss & Metabolic Conditioning",
    experience: "6+ years",
    location: "Bangalore",
    specialisation: "Fat Loss & Metabolic Conditioning",
    description: "Rajavel specialises in fat loss protocols for clients with demanding schedules. His approach combines metabolic conditioning with strategic nutrition cycling to drive results without sacrificing muscle.",
    color: "#22C55E",
    initials: "R",
  },
  {
    name: "Balaji",
    role: "Certified Trainer — Mobility & Corrective Exercise",
    experience: "7+ years",
    location: "Coimbatore",
    specialisation: "Mobility & Corrective Exercise",
    description: "Balaji addresses movement quality, injury prevention, and corrective exercise — ensuring clients can train hard without breaking down. Essential for high-volume professionals who carry tension from desk work.",
    color: "#3B82F6",
    initials: "B",
  },
];
...
const specialists = [
  {
    name: "Naren",
    role: "On-Call Nutrition Specialist",
    credentials: "ISSN-certified · Clinical Nutrition Diploma",
    location: "Hyderabad",
    description: "Naren provides advanced nutritional guidance for clients with complex dietary needs, clinical considerations, or performance-level goals. ISSN-certified with a clinical nutrition diploma.",
    color: "#A855F7",
    initials: "N",
  },
  {
    name: "Karthika DS",
    role: "On-Call Registered Dietician",
    credentials: "Registered Dietician · Food Science Degree",
    location: "Chennai",
    description: "Karthika brings clinical dietetics expertise to the team — handling medical dietary requirements, bloodwork interpretation, and evidence-based supplementation for clients who need specialist-level nutrition support.",
    color: "#F97316",
    initials: "K",
  },
];
