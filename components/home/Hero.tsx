      ...
      <svg viewBox={`0 0 ${w} ${h}`} style={{ width: "100%", height: "auto", overflow: "visible" }}>
        <defs>
          <linearGradient id="areaGrad" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0%" stopColor="#FFDE02" stopOpacity="0.3" />
            <stop offset="100%" stopColor="#FFDE02" stopOpacity="0" />
          </linearGradient>
          <linearGradient id="lineGrad" x1="0" y1="0" x2="1" y2="0">
            <stop offset="0%" stopColor="#E6C700" />
            <stop offset="100%" stopColor="#FFF07A" />
          </linearGradient>
        </defs>
        {drawn && (
        ...
        {drawn && (
          <circle cx={px(points.length - 1)} cy={py(points[points.length - 1])} r="3.5"
            fill="#FFDE02" stroke="#07070A" strokeWidth="1.5"
...
function MacroRing({ pct, color, label, value }: { pct: number; color: string; label: string; value: string }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "4px" }}>
      ...
      <span style={{ fontSize: "9px", color: "#7E8395", fontFamily: "'Plus Jakarta Sans', sans-serif", letterSpacing: "0.04em" }}>{label}</span>
...
function PhoneMockup() {
  ...
  return (
    <div className="phone-frame" style={{ width: "280px", height: "560px", margin: "0 auto", flexShrink: 0 }}>
      <div className="phone-screen" style={{ height: "100%", display: "flex", flexDirection: "column" }}>
        <div className="phone-notch">
          <div style={{ width: "8px", height: "8px", borderRadius: "50%", background: "#171717" }} />
          <div style={{ width: "44px", height: "8px", borderRadius: "4px", background: "#171717" }} />
        </div>

        <div style={{ flex: 1, overflowY: "hidden", padding: "12px 16px 16px" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "14px" }}>
            <div>
              <p style={{ fontSize: "10px", color: "#7E8395", fontFamily: "'Plus Jakarta Sans', sans-serif", marginBottom: "1px" }}>Good morning,</p>
            ...
            <div style={{ position: "relative" }}>
              ...
              <div style={{
                ...
                borderRadius: "50%", background: "#22C55E", border: "1.5px solid #07070A"
              }} />
            </div>
          </div>

          <div style={{
            background: "rgba(255,222,2,0.08)", border: "1px solid rgba(255,222,2,0.2)",
            borderRadius: "10px", padding: "10px 12px", marginBottom: "12px"
          }}>
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "6px" }}>
              <span style={{ fontSize: "10px", color: "#FFDE02", fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 700 }}>
                WEEK {week} OF 12
              </span>
              <span style={{ fontSize: "10px", color: "#7E8395", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
          ...
          <div style={{
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "8px" }}>
              <div>
                <p style={{ fontSize: "9px", color: "#7E8395", fontFamily: "'Plus Jakarta Sans', sans-serif", marginBottom: "2px", textTransform: "uppercase", letterSpacing: "0.06em" }}>Body Weight</p>
                <p style={{ fontSize: "20px", fontWeight: 800, color: "white", fontFamily: "'Plus Jakarta Sans', sans-serif", lineHeight: 1 }}>
                  {weightByWeek(week)}<span style={{ fontSize: "11px", color: "#7E8395", marginLeft: "2px" }}>kg</span>
                </p>
              </div>
              <div style={{ textAlign: "right" }}>
                <div style={{
                  display: "inline-flex", alignItems: "center", gap: "3px",
                  padding: "3px 7px", background: "rgba(34,197,94,0.14)",
                  border: "1px solid rgba(34,197,94,0.24)", borderRadius: "999px"
                }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", marginTop: "4px" }}>
              {["W1", "W4", "W8", "W12"].map(l => (
                <span key={l} style={{ fontSize: "8px", color: "#4A4D57", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>{l}</span>
              ))}
            </div>
          </div>
          ...
          <div style={{
            ...
            <p style={{ fontSize: "9px", color: "#7E8395", fontFamily: "'Plus Jakarta Sans', sans-serif", marginBottom: "10px", textTransform: "uppercase", letterSpacing: "0.06em" }}>Today's Nutrition</p>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "4px" }}>
              <MacroRing pct={0.78} color="#FFDE02" label="Protein" value="156g" />
          ...
          <div style={{
            ...
            background: "rgba(255,222,2,0.08)", border: "1px solid rgba(255,222,2,0.22)",
            borderRadius: "10px", padding: "10px 12px"
          }}>
            <div style={{
              width: "28px", height: "28px", borderRadius: "8px",
              background: "rgba(255,222,2,0.22)",
              display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0
            }}>
              <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                <path d="M3 7h2M9 7h2M5 7V4.5M9 7V4.5M5 4.5h4" stroke="#FFDE02" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
            </div>
            <div style={{ flex: 1, minWidth: 0 }}>
              <p style={{ fontSize: "9px", color: "#FFDE02", fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.05em" }}>Today</p>
            ...
            <div style={{
              fontSize: "9px", fontWeight: 700, color: "#07070A", fontFamily: "'Plus Jakarta Sans', sans-serif",
              background: "#FFDE02", padding: "3px 7px", borderRadius: "999px"
        ...
        <div style={{
          height: "48px", borderTop: "1px solid rgba(255,255,255,0.07)",
          display: "flex", alignItems: "center", justifyContent: "space-around",
          padding: "0 8px", background: "rgba(8,8,10,0.95)"
        }}>
          {[
            ...
            <div key={n.label} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "2px", color: n.active ? "#FFDE02" : "#4A4D57" }}>
              {n.svg}
              <span style={{ fontSize: "7px", color: n.active ? "#FFDE02" : "#4A4D57", fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 600 }}>{n.label}</span>
            </div>
          ))}
        </div>
      </div>
...
function CoachCard() {
  return (
    <div className="float-card-1 glass-card-bright" style={{
      ...
      <div style={{ display: "flex", alignItems: "flex-start", gap: "10px" }}>
        <div style={{
          ...
          background: "#FFDE02",
          display: "flex", alignItems: "center", justifyContent: "center",
          fontSize: "11px", fontWeight: 800, color: "#07070A", fontFamily: "'Plus Jakarta Sans', sans-serif"
        }}>G</div>
        <div>
...
function StreakCard() {
  return (
    <div className="float-card-2 glass-card-bright" style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
        <div style={{
          ...
          background: "rgba(255,222,2,0.18)", border: "1px solid rgba(255,222,2,0.3)",
          display: "flex", alignItems: "center", justifyContent: "center",
          color: "#FFDE02"
        }}>
        ...
        <div>
          <p style={{ fontSize: "16px", fontWeight: 800, color: "#FFDE02", fontFamily: "'Plus Jakarta Sans', sans-serif", lineHeight: 1 }}>8</p>
          <p style={{ fontSize: "9px", color: "#B7B9C3", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>week streak</p>
        </div>
      </div>
    </div>
  );
...
function WeightBadge() {
  return (
    <div className="float-card-3 glass-card-bright" style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
        ...
        <div>
          ...
          <p style={{ fontSize: "9px", color: "#B7B9C3", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>avg lost</p>
        </div>
      </div>
    </div>
  );
...
function SocialProof() {
  ...
  const colors = ["#FFDE02", "#22C55E", "#3B82F6", "#A855F7", "#F59E0B"];
  return (
    <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
      ...
      <div>
        <div style={{ display: "flex", gap: "1px", marginBottom: "2px" }}>
          {[...Array(5)].map((_, i) => (
            <svg key={i} width="11" height="11" viewBox="0 0 12 12" fill="#FFDE02">
              <path d="M6 1l1.3 3.9h4.1l-3.3 2.4 1.3 3.9L6 9 2.6 11.2l1.3-3.9L.6 4.9h4.1L6 1z" />
            </svg>
          ))}
        </div>
        <p style={{ fontSize: "12px", color: "#B7B9C3", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
...
export default function Hero() {
  ...
  return (
    ...
    >
      <ParticleNetwork count={85} linkDist={160} style={{ opacity: 0.65 }} />

      <div style={{
        position: "absolute", inset: 0,
        background: "radial-gradient(ellipse 70% 55% at 18% 42%, rgba(255,222,2,0.08) 0%, transparent 65%)",
        pointerEvents: "none"
      }} />
      <div style={{
        position: "absolute", inset: 0,
        background: "radial-gradient(ellipse 50% 40% at 85% 55%, rgba(255,255,255,0.03) 0%, transparent 70%)",
        pointerEvents: "none"
      }} />

      <div style={{
        position: "absolute", inset: 0,
        backgroundImage: "linear-gradient(rgba(255,222,2,0.035) 1px, transparent 1px), linear-gradient(90deg, rgba(255,222,2,0.035) 1px, transparent 1px)",
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", width: "100%", position: "relative" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "64px", alignItems: "center" }} className="hero-layout">
          {/* ── Left: Copy ── */}
          <div>
            <div style={{
              display: "inline-flex", alignItems: "center", gap: "8px", padding: "6px 14px",
              background: "rgba(34,197,94,0.10)", border: "1px solid rgba(34,197,94,0.24)",
              borderRadius: "999px", marginBottom: "28px",
              opacity: mounted ? 1 : 0, transform: mounted ? "translateY(0)" : "translateY(12px)",
              transition: "opacity 0.6s ease, transform 0.6s ease",
            }}>
              <div className="status-dot" />
              <span style={{ fontSize: "11px", fontWeight: 700, color: "#22C55E", fontFamily: "'Plus Jakarta Sans', sans-serif", letterSpacing: "0.08em", textTransform: "uppercase" }}>
            ...
            <h1 style={{
              ...
              <span className="gold-text">Stop guessing. Start calibrating.</span>
            </h1>

            <p style={{
              fontSize: "18px", color: "#B7B9C3", lineHeight: 1.65, marginBottom: "36px", maxWidth: "540px",
            ...
            <div style={{
              ...
              <Link href="/success-stories" className="btn-secondary" style={{ fontSize: "14px", padding: "17px 28px" }}>
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M4 2.5L11.5 7L4 11.5V2.5Z" fill="currentColor" /></svg>
            ...
            {/* Proof bullets */}
            <div style={{
              display: "flex", flexWrap: "wrap", gap: "10px 22px", marginBottom: "40px",
              opacity: mounted ? 1 : 0, transition: "opacity 0.7s ease 0.38s",
            }}>
              {proofBullets.map((b) => (
                <div key={b} style={{ display: "flex", alignItems: "center", gap: "7px" }}>
                  ...
                  <span style={{ fontSize: "13px", color: "#F5F3EE", fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 500 }}>{b}</span>
                </div>
              ))}
            </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              background: "radial-gradient(circle, rgba(255,222,2,0.14) 0%, transparent 70%)",
