    ...
    content: (
      <div style={{ padding: "20px 18px", height: "100%", display: "flex", flexDirection: "column", gap: "10px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div>
            <p style={{ fontSize: "10px", color: "#B7B9C3", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Welcome back</p>
            <p style={{ fontSize: "15px", fontWeight: 800, color: "white", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Alex Mitchell</p>
          </div>
          <div style={{ width: "36px", height: "36px", borderRadius: "50%", background: "linear-gradient(135deg,#FFDE02,#E6C700)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "14px", fontWeight: 800, color: "#07070A", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>A</div>
        </div>
        {/* Stat row */}
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "8px" }}>
          {[
            ...
            <div key={s.label} style={{ background: "rgba(255,255,255,0.04)", borderRadius: "10px", padding: "8px", textAlign: "center", border: "1px solid rgba(255,255,255,0.06)" }}>
              ...
              <p style={{ fontSize: "9px", color: "#B7B9C3", fontFamily: "'Plus Jakarta Sans', sans-serif", marginTop: "3px" }}>{s.label}</p>
            </div>
          ))}
        </div>
        {/* Chart placeholder */}
        <div style={{ background: "rgba(255,255,255,0.03)", borderRadius: "10px", padding: "10px", border: "1px solid rgba(255,255,255,0.06)", flex: 1 }}>
          <p style={{ fontSize: "9px", color: "#B7B9C3", fontFamily: "'Plus Jakarta Sans', sans-serif", marginBottom: "8px", textTransform: "uppercase", letterSpacing: "0.06em" }}>Weight Trend</p>
          <svg viewBox="0 0 200 60" style={{ width: "100%" }}>
            <defs>
              <linearGradient id="g1" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="#FFDE02" stopOpacity="0.2" />
                <stop offset="100%" stopColor="#FFDE02" stopOpacity="0" />
              </linearGradient>
            </defs>
            <path d="M0,50 C20,45 40,40 60,32 C80,24 100,20 120,16 C140,12 160,10 200,8" fill="none" stroke="#FFDE02" strokeWidth="2" strokeLinecap="round" />
            <path d="M0,50 C20,45 40,40 60,32 C80,24 100,20 120,16 C140,12 160,10 200,8 L200,60 L0,60 Z" fill="url(#g1)" />
          </svg>
        </div>
        {/* Today card */}
        <div style={{ background: "rgba(255,222,2,0.08)", border: "1px solid rgba(255,222,2,0.18)", borderRadius: "10px", padding: "10px 12px", display: "flex", alignItems: "center", gap: "10px" }}>
          <div style={{ width: "24px", height: "24px", borderRadius: "6px", background: "rgba(255,222,2,0.2)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, color: "#FFDE02" }}>
          ...
          <div>
            <p style={{ fontSize: "9px", color: "#FFDE02", fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 700 }}>TODAY</p>
  ...
  },
  {
    ...
    content: (
      <div style={{ padding: "16px 18px", height: "100%", overflowY: "auto" }}>
        ...
        <p style={{ fontSize: "9px", color: "#B7B9C3", fontFamily: "'Plus Jakarta Sans', sans-serif", marginBottom: "12px" }}>Today · 45–55 min</p>
        {[
          ...
          <div key={i} style={{
            ...
            <div style={{ flex: 1 }}>
              <p style={{ fontSize: "11px", fontWeight: 600, color: ex.done ? "#B7B9C3" : "white", fontFamily: "'Plus Jakarta Sans', sans-serif", textDecoration: ex.done ? "line-through" : "none" }}>{ex.name}</p>
            </div>
            <div style={{ textAlign: "right" }}>
              <p style={{ fontSize: "10px", color: "#FFDE02", fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 700 }}>{ex.sets}</p>
              <p style={{ fontSize: "9px", color: "#B7B9C3", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>{ex.load}</p>
            </div>
          </div>
        ))}
      </div>
      ...
      <div style={{ padding: "16px 18px", height: "100%", display: "flex", flexDirection: "column", gap: "10px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "16px", background: "rgba(255,255,255,0.03)", borderRadius: "12px", padding: "12px", border: "1px solid rgba(255,255,255,0.06)" }}>
          <svg width="64" height="64" viewBox="0 0 64 64">
            ...
            <circle cx="32" cy="32" r="26" fill="none" stroke="#FFDE02" strokeWidth="6"
          ...
          <div>
            ...
            <p style={{ fontSize: "9px", color: "#B7B9C3", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>of 2,250 kcal</p>
            <p style={{ fontSize: "9px", color: "#22C55E", fontFamily: "'Plus Jakarta Sans', sans-serif", marginTop: "3px" }}>630 remaining</p>
          </div>
        </div>
        {/* Macros */}
        {[
          { name: "Protein", eaten: 156, target: 200, color: "#FFDE02", unit: "g" },
          ...
          <div key={m.name}>
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "4px" }}>
              ...
              <span style={{ fontSize: "10px", color: "#B7B9C3", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>{m.eaten}/{m.target}{m.unit}</span>
            </div>
        ...
        {/* Recent meals */}
        <p style={{ fontSize: "9px", color: "#B7B9C3", fontFamily: "'Plus Jakarta Sans', sans-serif", textTransform: "uppercase", letterSpacing: "0.06em", marginTop: "4px" }}>Today's meals</p>
        {["Breakfast · 487 kcal", "Lunch · 634 kcal", "Snack · 210 kcal"].map((meal, i) => (
          <div key={i} style={{ display: "flex", justifyContent: "space-between", padding: "6px 0", borderBottom: "1px solid rgba(255,255,255,0.04)" }}>
            ...
            <span style={{ fontSize: "10px", color: "#B7B9C3", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>·{meal.split("·")[1]}</span>
          </div>
        ))}
      </div>
    ),
  },
  {
    ...
    content: (
      <div style={{ padding: "16px 18px", height: "100%", display: "flex", flexDirection: "column", gap: "10px" }}>
        ...
        {[
          { label: "Body Weight", start: "96.0 kg", current: "84.1 kg", delta: "−11.9 kg", pct: 79, color: "#FFDE02" },
          ...
          <div key={item.label} style={{ background: "rgba(255,255,255,0.03)", borderRadius: "10px", padding: "10px", border: "1px solid rgba(255,255,255,0.06)" }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "5px" }}>
              <span style={{ fontSize: "9px", color: "#B7B9C3", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Start: {item.start}</span>
              <span style={{ fontSize: "9px", color: "#B7B9C3", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Now: {item.current}</span>
            </div>
            <div className="progress-bar">
    ...
    content: (
      <div style={{ padding: "16px 18px", height: "100%", display: "flex", flexDirection: "column" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "14px", paddingBottom: "10px", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
          <div style={{ width: "30px", height: "30px", borderRadius: "50%", background: "linear-gradient(135deg,#FFDE02,#E6C700)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "12px", fontWeight: 800, color: "#07070A" }}>G</div>
          <div>
          ...
          {[
            ...
            <div key={i} style={{ display: "flex", flexDirection: "column", alignItems: msg.from === "me" ? "flex-end" : "flex-start" }}>
              <div style={{
                ...
                background: msg.from === "me" ? "rgba(255,222,2,0.15)" : "rgba(255,255,255,0.06)",
                border: `1px solid ${msg.from === "me" ? "rgba(255,222,2,0.2)" : "rgba(255,255,255,0.07)"}`,
              }}>
                <p style={{ fontSize: "10px", color: "white", fontFamily: "'Plus Jakarta Sans', sans-serif", lineHeight: 1.5 }}>{msg.text}</p>
              </div>
              <p style={{ fontSize: "8px", color: "#7E8395", fontFamily: "'Plus Jakarta Sans', sans-serif", marginTop: "3px" }}>{msg.time}</p>
            </div>
          ))}
        </div>
        {/* Input bar */}
        <div style={{ marginTop: "10px", display: "flex", gap: "6px", alignItems: "center" }}>
          <div style={{ flex: 1, padding: "8px 10px", background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "8px" }}>
            <p style={{ fontSize: "10px", color: "#7E8395", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>Message your coach…</p>
          </div>
          <div style={{ width: "28px", height: "28px", borderRadius: "8px", background: "rgba(255,222,2,0.2)", display: "flex", alignItems: "center", justifyContent: "center" }}>
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
              <path d="M2 10L10 6 2 2v3.5l5.5.5L2 6.5V10z" fill="#FFDE02" />
            </svg>
          </div>
        </div>
      </div>
...
export default function AppShowcase() {
  ...
  return (
    <section style={{ padding: "120px 0", background: "rgba(9,9,11,0.7)", position: "relative", overflow: "hidden" }}>
      {/* Background */}
      ...
      <div style={{ position: "absolute", top: 0, left: "50%", transform: "translateX(-50%)", width: "600px", height: "300px", background: "radial-gradient(ellipse, rgba(255,222,2,0.06) 0%, transparent 70%)", pointerEvents: "none" }} />
              ...
              {screens.map(s => (
                <button
                  ...
                  style={{
                    ...
                    padding: "18px 20px",
                    borderRadius: "14px",
                    border: `1px solid ${active === s.id ? "rgba(255,222,2,0.25)" : "transparent"}`,
                    background: active === s.id ? "rgba(255,222,2,0.07)" : "transparent",
                    cursor: "pointer",
                    textAlign: "left",
                ...
                >
                  <div style={{
                    ...
                    background: active === s.id ? "rgba(255,222,2,0.15)" : "rgba(255,255,255,0.05)",
                    border: `1px solid ${active === s.id ? "rgba(255,222,2,0.25)" : "rgba(255,255,255,0.08)"}`,
                    display: "flex", alignItems: "center", justifyContent: "center",
                    color: active === s.id ? "#FFDE02" : "#B7B9C3",
                    transition: "all 0.2s ease",
                  }}>
                    {s.icon}
                  </div>
                  <div>
                    <p style={{ fontSize: "15px", fontWeight: 700, color: active === s.id ? "white" : "#B7B9C3", fontFamily: "'Plus Jakarta Sans', sans-serif", marginBottom: "4px", transition: "color 0.2s" }}>
                      {s.label}
                    </p>
                    {active === s.id && (
                      <p style={{ fontSize: "13px", color: "#B7B9C3", fontFamily: "'Plus Jakarta Sans', sans-serif", lineHeight: 1.55 }}>
                        {s.description}
                      </p>
                    )}
                  </div>
                ...
                <div className="phone-screen" style={{ height: "100%", display: "flex", flexDirection: "column" }}>
                  ...
                  <div style={{ height: "28px", padding: "6px 16px 0", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    <div className="phone-notch" style={{ width: "80px", height: "20px", margin: 0, borderRadius: "0 0 12px 12px" }}>
                      <div style={{ width: "5px", height: "5px", borderRadius: "50%", background: "#171717" }} />
                      <div style={{ width: "36px", height: "5px", borderRadius: "3px", background: "#171717" }} />
                    </div>
                  ...
                  {/* Bottom nav */}
                  <div style={{ height: "52px", borderTop: "1px solid rgba(255,255,255,0.06)", display: "flex", alignItems: "center", justifyContent: "space-around", background: "rgba(8,8,10,0.95)" }}>
                    {screens.map(s => (
                      <button key={s.id} onClick={() => setActive(s.id)}
                        ...
                        <span style={{ color: active === s.id ? "#FFDE02" : "#7E8395", transition: "color 0.2s" }}>
                          {s.icon}
                        </span>
                        <span style={{ fontSize: "7px", fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 600, color: active === s.id ? "#FFDE02" : "#7E8395" }}>
